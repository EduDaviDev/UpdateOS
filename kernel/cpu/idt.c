...
/* IRQs 0-15 (remapeadas para vetores 32-47) */
...
void idt_init(void) {
    ...
    /* Remapeia o PIC para vetores 32-47 */
    pic_remap();

    /* Exceções da CPU: 0x08 = seletor de código do kernel, 0x8E = present, ring 0, interrupt gate */
